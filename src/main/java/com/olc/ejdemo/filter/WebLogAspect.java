...
public class WebLogAspect {
    ...
    @Pointcut("execution(public com.olc.ejdemo.web.base.view.ResponseVo com.olc..*Controller.*(..))")
    public void webLog() {
    }
    ...
    private String getParams(JoinPoint joinPoint) {
        ...
        return params.length() < 1000 ? params.toString() : params.substring(0, 1000) + "...";
    }
}
